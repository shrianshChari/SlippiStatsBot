        ...
        .then((value: AxiosResponse<unknown, any>) => {
          if (value.data instanceof Buffer) {
            ...
            if (data.gameData.stage.id != -1) {
              ...
              gameSummaryEmbed.setThumbnail(`https://raw.githubusercontent.com/project-slippi/slippi-launcher/main/src/renderer/styles/images/stages/${data.gameData.stage.id}.png`)
            }
